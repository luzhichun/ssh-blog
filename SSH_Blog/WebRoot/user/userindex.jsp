...
<html>
 <head>  
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/file/js/mynavmenu.js"></script>
...
<body style="background:#464646;">
	...
	<div id="user-header">
		<div id="blog_title">
            <h2>
                <a href="<%=request.getContextPath()%>/user/<s:property value="user.url"/>"><s:property value="user.username"/> 的博客</a></h2>

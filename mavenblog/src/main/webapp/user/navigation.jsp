...
<div class="crumb-wrap">
            ...
            <s:if test="%{currentPage == \"releaseArticle\"}">
			   <li class="active"><a href="./ReleaseArticle.jsp">发布文章</a></li>
			   <li><a href="./ArticleManage.jsp">文章管理</a></li>
			   <li>
			   ...
			   <li><a href="./modifyinfo.jsp">个人资料设置</a></li>
			</s:if>
			<s:elseif test="%{currentPage == \"articleManage\"}">
				<li><a href="./ReleaseArticle.jsp">发布文章</a></li>
			   <li class="active"><a href="./ArticleManage.jsp">文章管理</a></li>
			   <li>
			   		<a href="./CommentManage.jsp">评论管理</a>
			   		<s:if test="%{#session.user.msgCounts != null && #session.user.msgCounts != 0}">
						<span class="remind"><s:property value="#session.user.msgCounts"/></span>
			...
			<s:else>
			   ...
			   <li class="active"><a href="./modifyinfo.jsp">个人资料设置</a></li>
			</s:else>
			</ul>
</div>
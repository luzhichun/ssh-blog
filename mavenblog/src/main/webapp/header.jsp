...
<%@taglib uri="/struts-tags" prefix="s"%>
	<div id="header"> 
   <div id="header_inner"> 
    <strong class="logo"> <a href="index.action" class="png_bg" title="卧颜沉默">卧颜沉默</a> </strong> 
    <div class="header_bg png_bg"></div> 
    <div class="toplinks">
     <div id="_userlogin"> 
     <s:if test="%{#session.user == null}">
      <a href="user/login.action" title="用户登录">登录</a> 
      <span>|</span> 
      	<a href="user/register.action" title="注册">注册</a>
      	<span>|</span> 
      	<a href="admin/login.jsp" title="注册">管理员登录</a>
      </s:if>
      <s:else>
      	<a href="user/loginout.action" title="注销">注销</a>
      	<span>|</span> 
      	<a href="admin/login.jsp" title="注册">管理员登录</a>
      </s:else> 
     </div> 
     <div id="top_nav"> 
      <form name="formsearch" method="get" action="serach.action"> 
    ...
    <div id="navmenu"> 
     <ul> 
      ...
      <s:iterator value="#application.headerAndSider.parArticletypes">
	      <li><a href="sort.action?sortByColumn=<s:property value="linkname" />"><s:property value="value" /></a> 
	       <ul class="sub-menu">
	        <s:if test="%{chiArticletypes!=null}">
        		<s:iterator value="chiArticletypes">
	        		<li><a href="sort.action?sortByColumn=<s:property value="linkname" />"><s:property value="value" /></a></li>  
	        	</s:iterator>
	        </s:if>
	        <s:else>
   			 </s:else>
